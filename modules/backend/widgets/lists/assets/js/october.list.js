...
+(function ($) {
    ...
    var ListWidget = function (element, options) {
        ...
        var scrollClassContainer =
            options.scrollClassContainer !== undefined
    ...
    ListWidget.prototype.update = function () {
        ...
        $('.list-checkbox input[type="checkbox"]', body).each(function () {
            var $el = $(this);
            if ($el.is(":checked")) $el.closest("tr").addClass("active");
        });
        ...
        head.on("change", '.list-checkbox input[type="checkbox"]', function () {
            ...
            $('.list-checkbox input[type="checkbox"]', body).prop(
                "checked",
                checked
            );
            if (checked) $("tr", body).addClass("active");
            else $("tr", body).removeClass("active");
        });
        ...
        body.on("change", '.list-checkbox input[type="checkbox"]', function () {
            ...
            if (checked) {
                ...
                $('.list-checkbox input[type="checkbox"]', head).prop(
                    "checked",
                    false
                );
    ...
    ListWidget.prototype.getChecked = function () {
        ...
        return $('.list-checkbox input[type="checkbox"]', body)
            .map(function () {
                var $el = $(this);
    ...
    $.fn.listWidget = function (option) {
        ...
        this.each(function () {
            ...
            if (!data)
                $this.data(
                    "oc.listwidget",
                    (data = new ListWidget(this, options))
                );
