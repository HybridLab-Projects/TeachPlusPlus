    ...
    $.FE.LANGUAGE["el"] = {
        translation: {
            ...
            "Smiling face with open mouth and cold sweat":
                "Χαμόγελο με ανοιχτό στόμα και σταγόνα ιδρώτα",
            ...
            "Smiling face with heart-shaped eyes":
                "Χαμόγελο με μάτια σε σχήμα καρδιάς",
            ...
            "Face with stuck out tongue and winking eye":
                "Γλώσσα με κλείσιμο ματιού",
            "Face with stuck out tongue and tightly-closed eyes":
                "Γλώσσα με σφιχτά κλεισμένα μάτια",
            ...
            "Return focus to previous position":
                "Επιστροφή εστίασης στην προηγούμενη θέση",
