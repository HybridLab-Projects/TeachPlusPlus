    ...
    _.template = function (text, data, settings) {
        ...
        var source =
            ...
            text
                ...
                .replace(settings.interpolate || noMatch, function (
                    match,
                    code
                ) {
                    return "'+\n(" + unescape(code) + ")+\n'";
        ...
        getAllSnippets: function (syntax) {
            ...
            if (!cache[cacheKey]) {
                ...
                do {
                    ...
                    _.each(["snippets", "abbreviations"], function (
                        sectionName
                    ) {
                        var stackItem = {};
...
emmet.define("abbreviationUtils", function (require, _) {
    return {
        ...
        insertChildContent: function (text, childContent, options) {
            ...
            var utils = require("utils");
            text = utils.replaceVariables(text, function (
                variable,
                name,
                data
            ) {
    ...
    actions.add(
        ...
        function (editor) {
            if (!actions.run("insert_formatted_line_break_only", editor)) {
                ...
                var curPadding = require("editorUtils").getCurrentLinePadding(
                    editor
                );
                var content = String(editor.getContent());
                var caretPos = editor.getCaretPos();
...
emmet.exec(function (require, _) {
    ...
    function updateImageSizeHTML(editor) {
        ...
        if (xmlElem && (xmlElem.name() || "").toLowerCase() == "img") {
            getImageSizeForSource(editor, xmlElem.value("src"), function (
                size
            ) {
                if (size) {
...
emmet.define("cssResolver", function (require, _) {
    ...
    return (module = {
        ...
        normalizeValue: function (value, property) {
            ...
            return value.replace(/^(\-?[0-9\.]+)([a-z]*)$/, function (
                str,
                val,
                unit
            ) {
...
emmet.define("cssGradient", function (require, _) {
    ...
    function parseColorStop(colorStop) {
        ...
        if (colorStop) {
            ...
            colorStop.replace(/^(\-?[\d\.]+)([a-z%]+)?$/, function (
                str,
                pos,
                unit
            ) {
