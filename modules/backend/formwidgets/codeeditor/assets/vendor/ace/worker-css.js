...
ace.define("ace/mode/css/csslint", ["require", "exports", "module"], function (
    require,
    exports,
    module
) {
                ...
                additions = {
                    ...
                    _media: function () {
                        ...
                        while (true) {
                            if (tokenStream.peek() == Tokens.PAGE_SYM) {
                                ...
                                tokenStream.peek() == Tokens.VIEWPORT_SYM
                            ) {
                                this._viewport();
                    ...
                    _media_query: function () {
                        ...
                        if (type === null && expressions.length === 0) {
                            ...
                            while (tokenStream.match(Tokens.IDENT)) {
                                if (
                                    tokenStream.token().value.toLowerCase() !=
                                    "and"
                                ) {
                                    this._unexpectedToken(tokenStream.token());
                                }
                    ...
                    _namespace_prefix: function () {
                        ...
                        if (
                            ...
                            if (
                                tokenStream.match([Tokens.IDENT, Tokens.STAR])
                            ) {
                    ...
                    _pseudo: function () {
                        ...
                        if (tokenStream.match(Tokens.COLON)) {
                            ...
                            if (tokenStream.match(Tokens.IDENT)) {
                                ...
                                line = tokenStream.LT(1).startLine;
                                col =
                                    tokenStream.LT(1).startCol - colons.length;
            ...
            complex: {
                "<bg-position>": function (expression) {
                    var types = this,
                        ...
                        hasNext = function () {
                            return (
                                expression.hasNext() && expression.peek() != ","
                            );
                        };

                    while (
                        expression.peek(count) &&
                        expression.peek(count) != ","
                    ) {
                        count++;
                    }
                        ...
                        if (ValidationTypes.isAny(expression, xDir)) {
                            if (ValidationTypes.isAny(expression, yDir)) {
                                ...
                                if (ValidationTypes.isAny(expression, yDir)) {
                                    ...
                                    ValidationTypes.isAny(expression, "center")
                                ) {
                                    result = true;
                                }
                            }
                ...
                "<shadow>": function (expression) {
                    ...
                    if (expression.hasNext()) {
                        ...
                        while (
                            ValidationTypes.isAny(expression, "<length>") &&
                            count < 4
                        ) {
                            count++;
                        }
                ...
                "<flex>": function (expression) {
                    ...
                    if (ValidationTypes.isAny(expression, "none | inherit")) {
                        ...
                        if (ValidationTypes.isType(expression, "<flex-grow>")) {
                            ...
                            ValidationTypes.isType(expression, "<flex-basis>")
                        ) {
                            result = true;
                        }
                    }
