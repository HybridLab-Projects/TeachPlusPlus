...
ace.define(
    ...
    function (require, exports, module) {
        ...
        var HtmlHighlightRules = function () {
            ...
            this.embedTagRules(
                new JavaScriptHighlightRules({ noJSX: true }).getRules(),
                "js-",
                "script"
            );
        ...
        (function () {
            this.getCompletions = function (state, session, pos, prefix) {
                ...
                if (
                    ...
                    return this.getArrayKeyCompletions(
                        state,
                        session,
                        pos,
                        prefix
            ...
            this.getFunctionCompletions = function (
                state,
                session,
                pos,
                prefix
            ...
            this.getVariableCompletions = function (
                state,
                session,
                pos,
                prefix
            ...
            this.getArrayKeyCompletions = function (
                state,
                session,
                pos,
                prefix
...
ace.define(
    ...
    function (require, exports, module) {
        ...
        (function () {
            ...
            this.getNextLineIndent = function (state, line, tab) {
                var indent = this.$getIndent(line);
                var tokens = this.getTokenizer().getLineTokens(line, state)
                    .tokens;
                if (
                    tokens.length &&
                    tokens[tokens.length - 1].type == "comment"
    ...
    function (require, exports, module) {
        ...
        var XmlBehaviour = function () {
            this.add("string_dquotes", "insertion", function (
                ...
                if (text == '"' || text == "'") {
                    var quote = text;
                    var selected = session.doc.getTextRange(
            ...
            this.add("autoclosing", "insertion", function (
                ...
                if (text == ">") {
                    ...
                    var token =
                        iterator.getCurrentToken() || iterator.stepBackward();
                    if (
                        !token ||
                        !(
                            is(token, "tag-name") ||
                    ...
                    if (is(token, "attribute-value")) {
                        ...
                        if (firstChar == '"' || firstChar == "'") {
                            var lastChar = token.value.charAt(
...
ace.define(
    ...
    function (require, exports, module) {
        ...
        (function () {
            ...
            this._findEndTagInLine = function (
                session,
                row,
                tagName,
                startColumn
            ...
            this._pop = function (stack, tag) {
                while (stack.length) {
                    ...
                    if (!tag || top.tagName == tag.tagName) {
                        ...
                        this.optionalEndTags.hasOwnProperty(top.tagName)
                    ) {
                        stack.pop();
                        continue;
                    } else {
            ...
            this.getFoldWidgetRange = function (session, foldStyle, row) {
                ...
                if (!isBackward) {
                    var iterator = new TokenIterator(
                        session,
                        row,
                        firstTag.start.column
                    );
                    var start = {
                        row: row,
                        column:
                            firstTag.start.column + firstTag.tagName.length + 2,
                    };
...
ace.define(
    ...
    function (require, exports, module) {
        ...
        var FoldMode = (exports.FoldMode = function (
            ...
            MixedFoldMode.call(
                this,
                new XmlFoldMode(voidElements, optionalTags),
                {
    ...
    function (require, exports, module) {
        ...
        (function () {
            this.getCompletions = function (state, session, pos, prefix) {
                ...
                var line = session.getLine(pos.row).substr(0, pos.column);
                if (/&[A-z]*$/i.test(line))
                    return this.getHTMLEntityCompletions(
                        state,
                        session,
                        pos,
                        prefix
            ...
            this.getAttributeCompletions = function (
                state,
                session,
                pos,
                prefix
                ...
                if (tagName in attributeMap) {
                    attributes = attributes.concat(
                        Object.keys(attributeMap[tagName])
                    );
                }
...
ace.define(
    ...
    function (require, exports, module) {
        ...
        var oop = require("../lib/oop");
        var TextMode = require("./text").Mode;
        var PhpHighlightRules = require("./php_highlight_rules")
            .PhpHighlightRules;
        var PhpLangHighlightRules = require("./php_highlight_rules")
