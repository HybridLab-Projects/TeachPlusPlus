                        ...
                        (function (global) {
                            (function () {
                                ...
                                var nativeIsArray =
                                    ...
                                    nativeKeys =
                                        isNative((nativeKeys = Object.keys)) &&
                                        nativeKeys,
                                    nativeMax = Math.max,
                                    nativeMin = Math.min;
                                ...
                                (function (x) {
                                    ...
                                    support.funcDecomp = /\bthis\b/.test(
                                        function () {
                                            return this;
                                        }
                                    );
                                ...
                                function baseMerge(
                                    ...
                                    arrayEach(props || source, function (
                                        srcValue,
                                        key
                                    ) {
                                        if (props) {
                                    ...
                                    var index = -1,
                                        length =
                                            (array &&
                                                array.length &&
                                                arrayMax(
                                                    arrayMap(array, getLength)
                                                )) >>> 0,
                                        result = Array(length);

                                    while (++index < length) {
                                        result[index] = arrayMap(
                                            array,
                                            baseProperty(index)
                                        );
                                    }
                                ...
                                function reject(
                                    ...
                                    return func(collection, function (
                                        value,
                                        index,
                                        collection
                                    ) {
                                ...
                                function isArguments(value) {
                                    var length = isObjectLike(value)
                                        ? value.length
                                        : undefined;
                                    return (
                                        isLength(length) &&
                                        objToString.call(value) == argsTag
                                    );
                                }
                                ...
                                function has(object, path) {
                                    ...
                                    var result = hasOwnProperty.call(
                                        object,
                                        path
                                    );
                                    if (!result && !isKey(path)) {
                                        ...
                                        result =
                                            object != null &&
                                            hasOwnProperty.call(object, path);
                                    }
                                    return result;
                                }
                        ...
                        var JSHINT = (function () {
                            ...
                            function processenforceall() {
                                if (state.option.enforceall) {
                                    for (var enforceopt in options.bool
                                        .enforcing) {
                                        if (
                                            state.option[enforceopt] ===
                                                undefined &&
                                    ...
                                    for (var relaxopt in options.bool
                                        .relaxing) {
                                        if (
                                            state.option[relaxopt] === undefined
                                        ) {
                            ...
                            function expression(rbp, initial) {
                                ...
                                var isDangerous =
                                    state.option.asi &&
                                    state.tokens.prev.line !==
                                        startLine(state.tokens.curr) &&
                                    _.contains(
                                        ["]", ")"],
                            ...
                            typeofValues.es3 = typeofValues.es3.concat(
                                typeofValues.legacy
                            );
                            typeofValues.es6 = typeofValues.es3.concat(
                                "symbol"
                            );
                            ...
                            function checkLeftSideAssign(
                                ...
                                var allowDestructuring =
                                    options && options.allowDestructuring;
                                ...
                                if (left.identifier && !left.isMetaProperty) {
                                    state.funct["(scope)"].block.reassign(
                                        left.value,
                                        left
                                    );
                                }
                                ...
                                if (left.id === ".") {
                                    ...
                                    if (
                                        ...
                                        state.tokens.curr.left.destructAssign.forEach(
                                            function (t) {
                                                if (t.id) {
                                                    state.funct[
                                                        "(scope)"
                            ...
                            function parseFinalSemicolon() {
                                if (state.tokens.next.id !== ";") {
                                    ...
                                    var sameLine =
                                        startLine(state.tokens.next) ===
                                            state.tokens.curr.line &&
                                        state.tokens.next.id !== "(end)";
                                    var blockEnd = checkPunctuator(
                                        state.tokens.next,
                                        "}"
                                    );
                            ...
                            function comprehensiveArrayExpression() {
                                ...
                                if (state.tokens.next.value === "if") {
                                    advance("if");
                                    advance("(");
                                    state.funct["(comparray)"].setState(
                                        "filter"
                                    );
                            ...
                            function isMethod() {
                                return (
                                    (state.funct["(statement)"] &&
                                        state.funct["(statement)"].type ===
                                            "class") ||
                                    (state.funct["(context)"] &&
                                        state.funct["(context)"]["(verb)"] ===
                                            "class")
                                );
                            }
                            ...
                            function doTemplateLiteral(left) {
                                ...
                                function end() {
                                    ...
                                    if (complete) advance();
                                    return (
                                        complete || state.tokens.next.isUnclosed
                                    );
                                }
                            }
                            ...
                            function blockVariableStatement(
                                ...
                                for (;;) {
                                    ...
                                    statement.first = statement.first.concat(
                                        names
                                    );
                            ...
                            var conststatement = stmt("const", function (
                                context
                            ) {
                                return blockVariableStatement(
                                    "const",
                                    this,
                                    context
                                );
                            ...
                            blockstmt("if", function () {
                                ...
                                if (
                                    ...
                                    forinifcheck =
                                        state.forinifchecks[
                                            state.forinifchecks.length - 1
                                        ];
                                    if (
                                        expr.type === "(punctuator)" &&
                                        expr.value === "!"
                                    ) {
                            ...
                            stmt("export", function () {
                                ...
                                if (state.tokens.next.value === "{") {
                                    ...
                                    if (state.tokens.next.value === "from") {
                                        ...
                                        exportedTokens.forEach(function (
                                            token
                                        ) {
                                            state.funct["(scope)"].setExported(
                                                token.value,
                            ...
                            var lookupBlockType = function () {
                                ...
                                var ret = {};
                                if (
                                    checkPunctuators(state.tokens.curr, [
                                        "[",
                                        "{",
                                    ])
                                ) {
                            ...
                            var arrayComprehension = function () {
                                ...
                                var _current;
                                function declare(v) {
                                    var l = _current.variables.filter(function (
                                        elt
                                    ) {
                                        if (elt.value === v) {
                                            elt.undef = false;
                            ...
                            var itself = function (s, o, g) {
                                ...
                                scopeManagerInst.on("warning", function (ev) {
                                    warning.apply(
                                        null,
                                        [ev.code, ev.token].concat(ev.data)
                                    );
                                });
                                ...
                                if (o && o.ignoreDelimiters) {
                                    ...
                                    o.ignoreDelimiters.forEach(function (
                                        delimiterPair
                                    ) {
                                        if (
                                            !delimiterPair.start ||
                            ...
                            itself.data = function () {
                                ...
                                var impliedGlobals = state.funct[
                                    "(scope)"
                                ].getImpliedGlobals();
                                ...
                                for (i = 1; i < functions.length; i += 1) {
                                    ...
                                    fu.metrics = {
                                        complexity:
                                            f["(metrics)"].ComplexityCount,
                                        parameters: f["(metrics)"].arity,
                                        statements:
                                            f["(metrics)"].statementCount,
                                    };

                                    data.functions.push(fu);
                                }

                                var unuseds = state.funct[
                                    "(scope)"
                                ].getUnuseds();
                                if (unuseds.length > 0) {
                                    data.unused = unuseds;
                    ...
                    function (_dereq_, module, exports) {
                        ...
                        Lexer.prototype = {
                            ...
                            scanTemplateLiteral: function (checks) {
                                ...
                                while (this.peek() !== "`") {
                                    ...
                                    if (ch === "$" && this.peek(1) === "{") {
                                        ...
                                        var escape = this.scanEscapeSequence(
                                            checks
                                        );
                                        value += escape.char;
                            ...
                            scanStringLiteral: function (checks) {
                                ...
                                while (this.peek() !== quote) {
                                    if (this.peek() === "") {
                                        ...
                                        if (char === "\\") {
                                            var parsed = this.scanEscapeSequence(
                                                checks
                                            );
                                            char = parsed.char;
                                            jump = parsed.jump;
                            ...
                            next: function (checks) {
                                ...
                                if (match) {
                                    this.skip(
                                        match.tokenLength || match.value.length
                                    );
                                    return match;
                                }
                    ...
                    function (_dereq_, module, exports) {
                        ...
                        var scopeManager = function (
                            ...
                            function _getLabel(labelName) {
                                for (
                                    var i = _scopeStack.length - 1;
                                    i >= 0;
                                    --i
                                ) {
                                    var scopeLabels =
                                        _scopeStack[i]["(labels)"];
                            ...
                            var scopeManagerInst = {
                                ...
                                unstack: function () {
                                    var subScope =
                                        _scopeStack.length > 1
                                            ? _scopeStack[
                                                  _scopeStack.length - 2
                                              ]
                                            : null;
                                    var isUnstackingFunctionBody =
                                    ...
                                    var usedLabelNameList = Object.keys(
                                        currentUsages
                                    );

                                    if (
                                        currentUsages.__proto__ &&
                                        usedLabelNameList.indexOf(
                                            "__proto__"
                                        ) === -1
                                    ) {
                                    ...
                                    for (
                                        ...
                                        var usage =
                                            currentUsages[usedLabelName];
                                        var usedLabel =
                                            currentLabels[usedLabelName];
                                        if (usedLabel) {
                                            var usedLabelType =
                                                usedLabel["(type)"];
                                        ...
                                        if (subScope) {
                                            ...
                                            if (
                                                typeof _current["(predefined)"][
                                                    usedLabelName
                                                ] === "boolean"
                                            ) {
                                                delete declared[usedLabelName];
                                                usedPredefinedAndGlobals[
                                                    usedLabelName
                                                ] = marker;
                                                if (
                                                    _current["(predefined)"][
                                    ...
                                    if (!subScope) {
                                        Object.keys(declared).forEach(function (
                                            labelNotUsed
                                        ) {
                                            _warnUnused(
                                                labelNotUsed,
                                                declared[labelNotUsed],
                                                "var"
                                            );
                                        });
                                    }
                                ...
                                addParam: function (labelName, token, type) {
                                    ...
                                    if (
                                        _.has(_current["(labels)"], labelName)
                                    ) {
                                        _current["(labels)"][
                                            labelName
                                        ].duplicated = true;
                                    ...
                                    if (
                                        _.has(_current["(usages)"], labelName)
                                    ) {
                                        var usage =
                                            _current["(usages)"][labelName];
                                ...
                                validateParams: function () {
                                    ...
                                    var currentFunctParamScope =
                                        _currentFunctBody["(parent)"];
                                ...
                                getUsedOrDefinedGlobals: function () {
                                    ...
                                    if (
                                        usedPredefinedAndGlobals.__proto__ ===
                                            marker &&
                                ...
                                addlabel: function (labelName, opts) {
                                    ...
                                    if (isblockscoped) {
                                        ...
                                        if (
                                            ...
                                            declaredInCurrentScope = !!_currentFunctBody[
                                                "(parent)"
                                            ]["(labels)"][labelName];
                                        }
                                        if (
                                ...
                                funct: {
                                    labeltype: function (labelName, options) {
                                        var onlyBlockscoped =
                                            options && options.onlyBlockscoped;
                                        var excludeParams =
                                            options && options.excludeParams;
                                    ...
                                    has: function (labelName, options) {
                                        return Boolean(
                                            this.labeltype(labelName, options)
                                        );
                                    },
                                    add: function (
                                        labelName,
                                ...
                                block: {
                                    ...
                                    addBreakLabel: function (labelName, opts) {
                                        var token = opts.token;
                                        if (
                                            scopeManagerInst.funct.hasBreakLabel(
                                                labelName
                                            )
                                        ) {
                                            warning("E011", token, labelName);
                ...
                "/node_modules/jshint/src/style.js": [
                    function (_dereq_, module, exports) {
                        ...
                        exports.register = function (linter) {
                            linter.on("Identifier", function style_scanProto(
                                data
                            ) {
                            ...
                            linter.on("Identifier", function style_scanIterator(
                                data
                            ) {
                            ...
                            linter.on("String", function style_scanQuotes(
                                data
                            ) {
                            ...
                            linter.on("Number", function style_scanNumbers(
                                data
                            ) {
