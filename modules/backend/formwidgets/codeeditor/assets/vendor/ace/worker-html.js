        ...
        })(
            {
                1: [
                    function (_dereq_, module, exports) {
                        ...
                        ElementStack.prototype._inScope = function (
                            localName,
                            isMarker
                        ) {
                            for (
                        ...
                        ElementStack.prototype.pushHtmlElement = function (
                            item
                        ) {
                            this.rootNode = item.node;
                            this.push(item);
                        };
                        ElementStack.prototype.pushHeadElement = function (
                            item
                        ) {
                            this.headElement = item.node;
                            this.push(item);
                        };
                        ElementStack.prototype.pushBodyElement = function (
                            item
                        ) {
                        ...
                        ElementStack.prototype.popUntilPopped = function (
                            localName
                        ) {
                            var element;
                            do {
                        ...
                        ElementStack.prototype.inListItemScope = function (
                            localName
                        ) {
                        ...
                        ElementStack.prototype.inButtonScope = function (
                            localName
                        ) {
                            return this._inScope(
                                localName,
                        ...
                        ElementStack.prototype.inSelectScope = function (
                            localName
                        ) {
                            return this._inScope(
                                localName,
                        ...
                        ElementStack.prototype.findIndex = function (
                            localName
                        ) {
                            for (
                                var i = this.elements.length - 1;
                        ...
                        EntityParser.consumeEntity = function (
                            ...
                            if (ch == "#") {
                                ...
                                if (isDigit(ch)) {
                                    ...
                                    var replacement = this.replaceEntityNumbers(
                                        code
                                    );
                                    if (replacement) {
                                        tokenizer._parseError(
                                    ...
                                    if (code > 0xffff && code <= 0x10ffff) {
                                        code -= 0x10000;
                                        var first =
                                            ((0xffc00 & code) >> 10) + 0xd800;
                                        var second = (0x3ff & code) + 0xdc00;
                                        decodedCharacter = String.fromCharCode(
                                            first,
                                            second
                                        );
                                    } else
                            ...
                            if (
                                ...
                                var mostRecentMatch = "";
                                while (
                                    namedEntityPrefixes[consumedCharacters]
                                ) {
                                ...
                                if (
                                    ...
                                    if (
                                        ...
                                        mostRecentMatch.length
                                    ) {
                                        buffer.unget(
                                            consumedCharacters.substring(
                                                mostRecentMatch.length
                                            )
                                        );
                                    }
                    ...
                    function (_dereq_, module, exports) {
                        ...
                        InputStream.prototype = {
                            ...
                            shift: function (n) {
                                if (
                                    !this.eof &&
                                    this.start + n >= this.data.length
                                )
                                    throw InputStream.DRAIN;
                                if (this.eof && this.start >= this.data.length)
                                    return InputStream.EOF;
                                var d = this.data
                                    .slice(this.start, this.start + n)
                                    .toString();
                                this.advance(
                                    Math.min(n, this.data.length - this.start)
                                );
                                return d;
                            },
                            peek: function (n) {
                    ...
                    function (_dereq_, module, exports) {
                        ...
                        StackItem.prototype.isSpecial = function () {
                            return (
                                ...
                                SpecialElements[this.namespaceURI].indexOf(
                                    this.localName
                                ) > -1
                            );
                        };
                ...
                5: [
                    function (_dereq_, module, exports) {
                        var InputStream = _dereq_("./InputStream").InputStream;
                        var EntityParser = _dereq_("./EntityParser")
                            .EntityParser;
                        ...
                        Tokenizer.prototype.tokenize = function (source) {
                            ...
                            function character_reference_in_rcdata_state(
                                buffer
                            ) {
                                var character = EntityParser.consumeEntity(
                                    buffer,
                            ...
                            function script_data_escape_start_dash_state(
                                buffer
                            ) {
                                var data = buffer.char();
                                if (data === "-") {
                            ...
                            function script_data_escaped_state(buffer) {
                                ...
                                if (data === InputStream.EOF) {
                                    ...
                                    tokenizer.setState(
                                        script_data_escaped_less_then_sign_state
                                    );
                                } else if (data === "\u0000") {
                                    tokenizer._parseError("invalid-codepoint");
                                    tokenizer._emitToken({
                            ...
                            function script_data_escaped_dash_dash_state(
                                buffer
                            ) {
                                var data = buffer.char();
                                if (data === InputStream.EOF) {
                            ...
                            function script_data_escaped_end_tag_open_state(
                                buffer
                            ) {
                                var data = buffer.char();
                                if (isAlpha(data)) {
                            ...
                            function script_data_double_escape_start_state(
                                buffer
                            ) {
                                var data = buffer.char();
                                if (
                            ...
                            function script_data_double_escaped_dash_state(
                                buffer
                            ) {
                                var data = buffer.char();
                                if (data === InputStream.EOF) {
                            ...
                            function script_data_double_escaped_dash_dash_state(
                                buffer
                            ) {
                                var data = buffer.char();
                                if (data === InputStream.EOF) {
                            ...
                            function script_data_double_escaped_less_than_sign_state(
                                buffer
                            ) {
                                var data = buffer.char();
                                if (data === "/") {
                            ...
                            function script_data_double_escape_end_state(
                                buffer
                            ) {
                                var data = buffer.char();
                                if (
                            ...
                            function attribute_name_state(buffer) {
                                ...
                                if (leavingThisState) {
                                    ...
                                    for (
                                        var i = attributes.length - 2;
                                        i >= 0;
                                        i--
                                    ) {
                                        if (
                                            currentAttribute.nodeName ===
                            ...
                            function attribute_value_single_quoted_state(
                                buffer
                            ) {
                                var data = buffer.char();
                                if (data === InputStream.EOF) {
                            ...
                            function character_reference_in_attribute_value_state(
                                buffer
                            ) {
                                var character = EntityParser.consumeEntity(
                                    buffer,
                            ...
                            function markup_declaration_open_state(buffer) {
                                ...
                                if (chars === "--") {
                                    ...
                                    if (
                                        newchars === InputStream.EOF ||
                                        chars === InputStream.EOF
                                    ) {
                                        tokenizer._parseError(
                            ...
                            function after_doctype_name_state(buffer) {
                                ...
                                if (data === InputStream.EOF) {
                                    ...
                                    if (["p", "P"].indexOf(data) > -1) {
                                        ...
                                        var matched = expected.every(function (
                                            expected
                                        ) {
                                            data = buffer.char();
                            ...
                            function before_doctype_public_identifier_state(
                                buffer
                            ) {
                                var data = buffer.char();
                                if (data === InputStream.EOF) {
                            ...
                            function after_doctype_system_keyword_state(
                                buffer
                            ) {
                                var data = buffer.char();
                                if (data === InputStream.EOF) {
                            ...
                            function before_doctype_system_identifier_state(
                                buffer
                            ) {
                                var data = buffer.char();
                                if (data === InputStream.EOF) {
                            ...
                            function doctype_system_identifier_double_quoted_state(
                                buffer
                            ) {
                                var data = buffer.char();
                                if (data === InputStream.EOF) {
                            ...
                            function doctype_system_identifier_single_quoted_state(
                                buffer
                            ) {
                                var data = buffer.char();
                                if (data === InputStream.EOF) {
                            ...
                            function after_doctype_system_identifier_state(
                                buffer
                            ) {
                                var data = buffer.char();
                                if (data === InputStream.EOF) {
                ...
                6: [
                    function (_dereq_, module, exports) {
                        ...
                        var ElementStack = _dereq_("./ElementStack")
                            .ElementStack;
                        ...
                        function isAllWhitespaceOrReplacementCharacters(
                            characters
                        ) {
                            for (var i = 0; i < characters.length; i++) {
                                var ch = characters[i];
                        ...
                        CharacterBuffer.prototype.skipLeadingWhitespace = function () {
                            while (
                                isWhitespace(this.characters[this.current])
                            ) {
                        ...
                        function TreeBuilder() {
                            ...
                            modes.base = {
                                ...
                                processEOF: function () {
                                    ...
                                    if (tree.openElements.length > 2) {
                                        ...
                                        tree.openElements.item(1).localName !=
                                            "body"
                                    ) {
                                        tree.parseError(
                                            "expected-closing-tag-but-got-eof"
                            ...
                            modes.initial.processCharacters = function (
                                buffer
                            ) {
                            ...
                            modes.beforeHTML.processCharacters = function (
                                buffer
                            ) {
                                buffer.skipLeadingWhitespace();
                                if (!buffer.length) return;
                            ...
                            modes.afterAfterBody.processCharacters = function (
                                data
                            ) {
                                if (!isAllWhitespace(data.characters)) {
                                    ...
                                    tree.setInsertionMode("inBody");
                                    return tree.insertionMode.processCharacters(
                                        data
                                    );
                                }
                            ...
                            modes.afterBody.processCharacters = function (
                                data
                            ) {
                                if (!isAllWhitespace(data.characters)) {
                                    tree.parseError(
                            ...
                            modes.afterFrameset.processCharacters = function (
                                buffer
                            ) {
                            ...
                            modes.afterFrameset.startTagOther = function (
                                name,
                                attributes
                            ) {
                                tree.parseError(
                            ...
                            modes.beforeHead.processCharacters = function (
                                buffer
                            ) {
                                buffer.skipLeadingWhitespace();
                                if (!buffer.length) return;
                            ...
                            modes.beforeHead.startTagHead = function (
                                name,
                                attributes
                            ) {
                            ...
                            modes.inHead.startTagHead = function (
                                name,
                                attributes
                            ) {
                                tree.parseError(
                            ...
                            modes.inHead.startTagTitle = function (
                                name,
                                attributes
                            ) {
                                tree.processGenericRCDATAStartTag(
                                    name,
                                    attributes
                                );
                            };

                            modes.inHead.startTagNoScript = function (
                                name,
                                attributes
                            ) {
                            ...
                            modes.inHead.startTagNoFramesStyle = function (
                                name,
                                attributes
                            ) {
                            ...
                            modes.inHead.startTagScript = function (
                                name,
                                attributes
                            ) {
                                tree.insertElement(name, attributes);
                                tree.tokenizer.setState(Tokenizer.SCRIPT_DATA);
                                tree.originalInsertionMode =
                                    tree.insertionModeName;
                            ...
                            modes.inHead.startTagMeta = function (
                                name,
                                attributes
                            ) {
                                tree.insertSelfClosingElement(name, attributes);
                            ...
                            modes.afterHead.processCharacters = function (
                                buffer
                            ) {
                                var leadingWhitespace = buffer.takeLeadingWhitespace();
                                if (leadingWhitespace)
                            ...
                            modes.afterHead.startTagBody = function (
                                name,
                                attributes
                            ) {
                            ...
                            modes.afterHead.startTagFrameset = function (
                                name,
                                attributes
                            ) {
                                tree.insertElement(name, attributes);
                            ...
                            modes.inBody.processCharacters = function (buffer) {
                                ...
                                if (
                                    tree.framesetOk &&
                                    !isAllWhitespaceOrReplacementCharacters(
                                        characters
                                    )
                                )
                                    tree.framesetOk = false;
                            ...
                            modes.inBody.startTagHtml = function (
                                name,
                                attributes
                            ) {
                            ...
                            modes.inBody.startTagBody = function (
                                name,
                                attributes
                            ) {
                                tree.parseError("unexpected-start-tag", {
                            ...
                            modes.inBody.startTagFrameset = function (
                                name,
                                attributes
                            ) {
                                tree.parseError("unexpected-start-tag", {
                            ...
                            modes.inBody.startTagCloseP = function (
                                name,
                                attributes
                            ) {
                            ...
                            modes.inBody.startTagPreListing = function (
                                name,
                                attributes
                            ) {
                                if (tree.openElements.inButtonScope("p"))
                            ...
                            modes.inBody.startTagForm = function (
                                name,
                                attributes
                            ) {
                                if (tree.form) {
                            ...
                            modes.inBody.startTagRpRt = function (
                                name,
                                attributes
                            ) {
                                if (tree.openElements.inScope("ruby")) {
                                    tree.generateImpliedEndTags();
                                    if (
                                        tree.currentStackItem().localName !=
                                        "ruby"
                                    ) {
                                        tree.parseError(
                            ...
                            modes.inBody.startTagListItem = function (
                                name,
                                attributes
                            ) {
                                var stopNames = {
                                ...
                                for (var i = els.length - 1; i >= 0; i--) {
                                    var node = els.item(i);
                                    if (
                                        stopName.indexOf(node.localName) != -1
                                    ) {
                                        tree.insertionMode.processEndTag(
                                            node.localName
                                        );
                                        break;
                                    }
                            ...
                            modes.inBody.startTagPlaintext = function (
                                name,
                                attributes
                            ) {
                                if (tree.openElements.inButtonScope("p"))
                            ...
                            modes.inBody.startTagHeading = function (
                                name,
                                attributes
                            ) {
                                if (tree.openElements.inButtonScope("p"))
                                    this.endTagP("p");
                                if (
                                    tree.currentStackItem().isNumberedHeader()
                                ) {
                                    tree.parseError("unexpected-start-tag", {
                                        name: name,
                                    });
                            ...
                            modes.inBody.startTagA = function (
                                name,
                                attributes
                            ) {
                                ...
                                if (activeA) {
                                    ...
                                    tree.removeElementFromActiveFormattingElements(
                                        activeA
                                    );
                                }
                                tree.reconstructActiveFormattingElements();
                            ...
                            modes.inBody.startTagFormatting = function (
                                name,
                                attributes
                            ) {
                                tree.reconstructActiveFormattingElements();
                            ...
                            modes.inBody.startTagNobr = function (
                                name,
                                attributes
                            ) {
                                tree.reconstructActiveFormattingElements();
                            ...
                            modes.inBody.startTagButton = function (
                                name,
                                attributes
                            ) {
                            ...
                            modes.inBody.endTagAppletMarqueeObject = function (
                                name
                            ) {
                            ...
                            modes.inBody.startTagXmp = function (
                                name,
                                attributes
                            ) {
                                if (tree.openElements.inButtonScope("p"))
                            ...
                            modes.inBody.startTagTable = function (
                                name,
                                attributes
                            ) {
                            ...
                            modes.inBody.startTagVoidFormatting = function (
                                name,
                                attributes
                            ) {
                                tree.reconstructActiveFormattingElements();
                            ...
                            modes.inBody.startTagHr = function (
                                name,
                                attributes
                            ) {
                                if (tree.openElements.inButtonScope("p"))
                            ...
                            modes.inBody.startTagImage = function (
                                name,
                                attributes
                            ) {
                                tree.parseError(
                            ...
                            modes.inBody.startTagInput = function (
                                name,
                                attributes
                            ) {
                            ...
                            modes.inBody.startTagIsindex = function (
                                name,
                                attributes
                            ) {
                            ...
                            modes.inBody.startTagTextarea = function (
                                name,
                                attributes
                            ) {
                                tree.insertElement(name, attributes);
                            ...
                            modes.inBody.startTagIFrame = function (
                                name,
                                attributes
                            ) {
                                tree.framesetOk = false;
                            ...
                            modes.inBody.startTagRawText = function (
                                name,
                                attributes
                            ) {
                                tree.processGenericRawTextStartTag(
                            ...
                            modes.inBody.startTagSelect = function (
                                name,
                                attributes
                            ) {
                                tree.reconstructActiveFormattingElements();
                            ...
                            modes.inBody.startTagMisplaced = function (
                                name,
                                attributes
                            ) {
                                tree.parseError(
                            ...
                            modes.inBody.startTagOptionOptgroup = function (
                                name,
                                attributes
                            ) {
                                if (
                            ...
                            modes.inBody.startTagOther = function (
                                name,
                                attributes
                            ) {
                                tree.reconstructActiveFormattingElements();
                            ...
                            modes.inBody.endTagOther = function (name) {
                                var node;
                                for (
                                    var i = tree.openElements.length - 1;
                                    i > 0;
                                    i--
                                ) {
                                    ...
                                    if (node.localName == name) {
                                        ...
                                        tree.openElements.remove_openElements_until(
                                            function (x) {
                                                return x === node;
                                            }
                                        );
                            ...
                            modes.inBody.startTagMath = function (
                                ...
                                tree.reconstructActiveFormattingElements();
                                attributes = tree.adjustMathMLAttributes(
                                    attributes
                                );
                                attributes = tree.adjustForeignAttributes(
                                    attributes
                                );
                            ...
                            modes.inBody.startTagSVG = function (
                                ...
                                tree.reconstructActiveFormattingElements();
                                attributes = tree.adjustSVGAttributes(
                                    attributes
                                );
                                attributes = tree.adjustForeignAttributes(
                                    attributes
                            ...
                            modes.inBody.endTagP = function (name) {
                                if (!tree.openElements.inButtonScope("p")) {
                                    ...
                                    if (
                                        tree.currentStackItem().localName != "p"
                                    )
                                        tree.parseError(
                            ...
                            modes.inBody.endTagBody = function (name) {
                                ...
                                if (
                                    tree.currentStackItem().localName != "body"
                                ) {
                                    tree.parseError(
                                        "expected-one-end-tag-but-got-another",
                                        {
                                            expectedName: tree.currentStackItem()
                                                .localName,
                                            gotName: name,
                                        }
                                    );
                            ...
                            modes.inBody.endTagHeading = function (name) {
                                if (
                                    !tree.openElements.hasNumberedHeaderElementInScope()
                                ) {
                                    tree.parseError("unexpected-end-tag", {
                                        name: name,
                                    });
                            ...
                            modes.inBody.endTagFormatting = function (
                                name,
                                attributes
                            ) {
                            ...
                            modes.inCaption.startTagTableElement = function (
                                name,
                                attributes
                            ) {
                                tree.parseError("unexpected-end-tag", {
                                ...
                                var ignoreEndTag = !tree.openElements.inTableScope(
                                    "caption"
                                );
                            ...
                            modes.inCaption.endTagCaption = function (name) {
                                if (
                                    !tree.openElements.inTableScope("caption")
                                ) {
                                    assert.ok(tree.context);
                                    tree.parseError("unexpected-end-tag", {
                                        name: name,
                            ...
                            modes.inColumnGroup.processCharacters = function (
                                buffer
                            ) {
                                var leadingWhitespace = buffer.takeLeadingWhitespace();
                                if (leadingWhitespace)
                                ...
                                if (!ignoreEndTag)
                                    tree.insertionMode.processCharacters(
                                        buffer
                                    );
                            };
                            ...
                            modes.inColumnGroup.endTagColgroup = function (
                                name
                            ) {
                            ...
                            modes.inForeignContent.processEndTag = function (
                                name
                            ) {
                            ...
                            modes.inForeignContent.processCharacters = function (
                                buffer
                            ) {
                                var characters = buffer.takeRemaining();
                                characters = characters.replace(
                            ...
                            modes.inHeadNoscript.processCharacters = function (
                                buffer
                            ) {
                                var leadingWhitespace = buffer.takeLeadingWhitespace();
                                if (leadingWhitespace)
                            ...
                            modes.inHeadNoscript.startTagBasefontBgsoundLinkMetaNoframesStyle = function (
                                name,
                                attributes
                            ) {
                                modes.inHead.processStartTag(name, attributes);
                            ...
                            modes.inHeadNoscript.startTagOther = function (
                                name,
                                attributes
                            ) {
                                tree.parseError(
                            ...
                            modes.inHeadNoscript.endTagBr = function (
                                name,
                                attributes
                            ) {
                                tree.parseError(
                            ...
                            modes.inHeadNoscript.endTagNoscript = function (
                                name,
                                attributes
                            ) {
                                tree.popElement();
                            ...
                            modes.inHeadNoscript.endTagOther = function (
                                name,
                                attributes
                            ) {
                                tree.parseError(
                            ...
                            modes.inFrameset.startTagOther = function (
                                name,
                                attributes
                            ) {
                                tree.parseError(
                            ...
                            modes.inFrameset.endTagFrameset = function (
                                name,
                                attributes
                            ) {
                                if (
                            ...
                            modes.inTable.processCharacters = function (data) {
                                if (
                                    tree.currentStackItem().isFosterParenting()
                                ) {
                                    var originalInsertionMode =
                                        tree.insertionModeName;
                            ...
                            modes.inTable.startTagCaption = function (
                                name,
                                attributes
                            ) {
                            ...
                            modes.inTable.startTagColgroup = function (
                                name,
                                attributes
                            ) {
                                tree.openElements.popUntilTableScopeMarker();
                            ...
                            modes.inTable.startTagCol = function (
                                name,
                                attributes
                            ) {
                            ...
                            modes.inTable.startTagRowGroup = function (
                                name,
                                attributes
                            ) {
                                tree.openElements.popUntilTableScopeMarker();
                            ...
                            modes.inTable.startTagImplyTbody = function (
                                name,
                                attributes
                            ) {
                            ...
                            modes.inTable.startTagTable = function (
                                name,
                                attributes
                            ) {
                                tree.parseError(
                            ...
                            modes.inTable.startTagForm = function (
                                name,
                                attributes
                            ) {
                            ...
                            modes.inTableText.processCharacters = function (
                                buffer
                            ) {
                                var characters = buffer.takeRemaining();
                                characters = characters.replace(
                            ...
                            modes.inTableText.processEndTag = function (
                                name,
                                attributes
                            ) {
                                this.flushCharacters();
                            ...
                            modes.inTableBody.startTagTr = function (
                                name,
                                attributes
                            ) {
                            ...
                            modes.inTableBody.startTagTableCell = function (
                                name,
                                attributes
                            ) {
                                tree.parseError(
                            ...
                            modes.inTableBody.startTagTableOther = function (
                                name,
                                attributes
                            ) {
                                if (
                            ...
                            modes.inTableBody.endTagTableRowGroup = function (
                                name
                            ) {
                                if (tree.openElements.inTableScope(name)) {
                                    tree.openElements.popUntilTableBodyScopeMarker();
                            ...
                            modes.inSelect.processCharacters = function (
                                buffer
                            ) {
                            ...
                            modes.inSelect.startTagOption = function (
                                name,
                                attributes
                            ) {
                                if (
                            ...
                            modes.inSelect.startTagOptgroup = function (
                                name,
                                attributes
                            ) {
                                if (
                            ...
                            modes.inSelect.startTagInput = function (
                                name,
                                attributes
                            ) {
                            ...
                            modes.inSelect.endTagTableElements = function (
                                name
                            ) {
                                tree.parseError(
                                    "unexpected-end-tag-in-select",
                            ...
                            modes.inSelect.startTagOther = function (
                                name,
                                attributes
                            ) {
                                tree.parseError(
                            ...
                            modes.inSelectInTable.startTagTable = function (
                                name,
                                attributes
                            ) {
                                tree.parseError(
                            ...
                            modes.inSelectInTable.startTagOther = function (
                                ...
                                modes.inSelect.processStartTag(
                                    name,
                                    attributes,
                                    selfClosing
                                );
                            ...
                            modes.inSelectInTable.endTagTable = function (
                                name
                            ) {
                                tree.parseError(
                            ...
                            modes.inRow.startTagTableCell = function (
                                name,
                                attributes
                            ) {
                            ...
                            modes.inRow.startTagTableOther = function (
                                name,
                                attributes
                            ) {
                            ...
                            modes.afterAfterFrameset = Object.create(
                                modes.base
                            );
                            ...
                            modes.afterAfterFrameset.processCharacters = function (
                                buffer
                            ) {
                                var characters = buffer.takeRemaining();
                                var whitespace = "";
                        ...
                        TreeBuilder.prototype.setInsertionMode = function (
                            name
                        ) {
                            this.insertionMode = this.insertionModes[name];
                            this.insertionModeName = name;
                        };
                        TreeBuilder.prototype.adoptionAgencyEndTag = function (
                            name
                        ) {
                            ...
                            while (outerLoopCounter++ < outerIterationLimit) {
                                formattingElement = this.elementInActiveFormattingElements(
                                    name
                                );

                                if (
                                    !formattingElement ||
                                    (this.openElements.contains(
                                        formattingElement
                                    ) &&
                                ...
                                if (
                                    formattingElement != this.currentStackItem()
                                ) {
                                ...
                                var afeIndex = this.openElements.elements.indexOf(
                                    formattingElement
                                );
                                var commonAncestor = this.openElements.item(
                                    afeIndex - 1
                                );

                                var bookmark = this.activeFormattingElements.indexOf(
                                    formattingElement
                                );

                                var node = furthestBlock;
                                var lastNode = furthestBlock;
                                var index = this.openElements.elements.indexOf(
                                    node
                                );

                                var innerLoopCounter = 0;
                                while (
                                    innerLoopCounter++ < innerIterationLimit
                                ) {
                                    index -= 1;
                        ...
                        TreeBuilder.prototype.startTokenization = function (
                            tokenizer
                        ) {
                        ...
                        TreeBuilder.prototype.processToken = function (token) {
                            ...
                            if (
                                ...
                                (currentNode.isHtmlIntegrationPoint() &&
                                    token.type in
                                        { StartTag: 0, Characters: 0 }) ||
                                token.type == "EOF"
                            ) {
                                insertionMode = this.insertionMode;
                            } else {
                                insertionMode = this.insertionModes
                                    .inForeignContent;
                            }
                            switch (token.type) {
                                case "Characters":
                        ...
                        TreeBuilder.prototype.insertHtmlElement = function (
                            attributes
                        ) {
                        ...
                        TreeBuilder.prototype.insertHeadElement = function (
                            attributes
                        ) {
                        ...
                        TreeBuilder.prototype.insertBodyElement = function (
                            attributes
                        ) {
                            var element = this.createElement(
                                "http://www.w3.org/1999/xhtml",
                        ...
                        TreeBuilder.prototype.insertIntoFosterParent = function (
                            node
                        ) {
                            var tableIndex = this.openElements.findIndex(
                                "table"
                            );
                            var tableElement = this.openElements.item(
                                tableIndex
                            ).node;
                            if (tableIndex === 0)
                        ...
                        TreeBuilder.prototype.generateImpliedEndTags = function (
                            exclude
                        ) {
                        ...
                        TreeBuilder.prototype.ensureNoahsArkCondition = function (
                            item
                        ) {
                            ...
                            for (
                                ...
                                var candidate = this.activeFormattingElements[
                                    i
                                ];
                        ...
                        TreeBuilder.prototype.appendElementToActiveFormattingElements = function (
                            item
                        ) {
                            this.ensureNoahsArkCondition(item);
                            this.activeFormattingElements.push(item);
                        };
                        TreeBuilder.prototype.removeElementFromActiveFormattingElements = function (
                            item
                        ) {
                            var index = this.activeFormattingElements.indexOf(
                                item
                            );
                            if (index >= 0)
                        ...
                        TreeBuilder.prototype.setFragmentContext = function (
                            context
                        ) {
                            this.context = context;
                        };
                        TreeBuilder.prototype.parseError = function (
                            code,
                            args
                        ) {
                        ...
                        TreeBuilder.prototype.adjustMathMLAttributes = function (
                            attributes
                        ) {
                        ...
                        TreeBuilder.prototype.adjustSVGAttributes = function (
                            attributes
                        ) {
                            attributes.forEach(function (a) {
                                ...
                                if (constants.SVGAttributeMap[a.nodeName])
                                    a.nodeName =
                                        constants.SVGAttributeMap[a.nodeName];
                            });
                            return attributes;
                        };
                ...
                9: [
                    function (_dereq_, module, exports) {
                        var SAXTreeBuilder = _dereq_("./SAXTreeBuilder")
                            .SAXTreeBuilder;
                        var Tokenizer = _dereq_("../Tokenizer").Tokenizer;
                        ...
                        SAXParser.prototype.parse = function (source) {
                            ...
                            if (document) {
                                new TreeParser(this.contentHandler).parse(
                                    document
                                );
                            }
                        };

                        SAXParser.prototype.parseFragment = function (
                            source,
                            context
                        ) {
                ...
                10: [
                    function (_dereq_, module, exports) {
                        ...
                        SAXTreeBuilder.prototype.insertComment = function (
                            data,
                            parent
                        ) {
                        ...
                        SAXTreeBuilder.prototype.appendCharacters = function (
                            parent,
                            data
                        ) {
                        ...
                        SAXTreeBuilder.prototype.insertText = function (data) {
                            if (
                                ...
                                var tableItem = this.openElements.item(
                                    tableIndex
                                );
                                ...
                                if (parent) {
                                    parent.insertBetween(
                                        text,
                                        table.previousSibling,
                                        table
                                    );
                                    return;
                                }
                                var stackParent = this.openElements.item(
                                    tableIndex - 1
                                ).node;
                        ...
                        ParentNode.prototype.insertBefore = function (
                            child,
                            sibling
                        ) {
                            if (!sibling) {
                        ...
                        ParentNode.prototype.insertBetween = function (
                            child,
                            prev,
                            next
                        ) {
                        ...
                        ParentNode.prototype.appendChildren = function (
                            parent
                        ) {
                        ...
                        Document.prototype = Object.create(
                            ParentNode.prototype
                        );
                        ...
                        DocumentFragment.prototype = Object.create(
                            ParentNode.prototype
                        );
                        DocumentFragment.prototype.visit = function (
                            treeParser
                        ) {};
                        function Element(
                            locator,
                        ...
                        IgnorableWhitespace.prototype = Object.create(
                            Node.prototype
                        );
                        IgnorableWhitespace.prototype.visit = function (
                            treeParser
                        ) {
                        ...
                        ProcessingInstruction.prototype = Object.create(
                            Node.prototype
                        );
                        ProcessingInstruction.prototype.visit = function (
                            treeParser
                        ) {
                            treeParser.processingInstruction(
                                this.target,
                                this.data,
                                this
                            );
                ...
                11: [
                    function (_dereq_, module, exports) {
                        ...
                        TreeParser.prototype.endPrefixMapping = function (
                            prefix,
                            locator
                        ) {
                            this.locatorDelegate = locator;
                        ...
                        TreeParser.prototype.skippedEntity = function (
                            name,
                            locator
                        ) {
                            this.locatorDelegate = locator;
                        ...
                        TreeParser.prototype.startDocument = function (
                            locator
                        ) {
                            this.locatorDelegate = locator;
                        ...
                        TreeParser.prototype.comment = function (
                            ch,
                            start,
                            length,
                            locator
                        ...
                        TreeParser.prototype.endEntity = function (
                            name,
                            locator
                        ) {
                            this.locatorDelegate = locator;
                        ...
                        TreeParser.prototype.startDTD = function (
                            ...
                            this.locatorDelegate = locator;
                            this.lexicalHandler.startDTD(
                                name,
                                publicId,
                                systemId
                            );
                        };
                        TreeParser.prototype.startEntity = function (
                            name,
                            locator
                        ) {
                            this.locatorDelegate = locator;
