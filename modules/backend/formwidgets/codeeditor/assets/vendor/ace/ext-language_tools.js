        ...
        (function () {
            ...
            this.expandSnippetForSelection = function (editor, options) {
                ...
                this.getActiveScopes(editor).some(function (scope) {
                    ...
                    if (snippets)
                        snippet = this.findMatchingSnippet(
                            snippets,
                            before,
                            after
                        );
            ...
            this.findMatchingSnippet = function (snippetList, before, after) {
                for (var i = snippetList.length; i--; ) {
                    ...
                    s.replaceBefore = s.triggerRe
                        ? s.triggerRe.exec(before)[0]
                        : "";
                    s.replaceAfter = s.endTriggerRe
                        ? s.endTriggerRe.exec(after)[0]
                        : "";
                    return s;
                }
            };
        ...
        (function () {
            ...
            this.onChangeSelection = function () {
                ...
                for (var i = this.ranges.length; i--; ) {
                    ...
                    var containsLead = this.ranges[i].contains(
                        lead.row,
                        lead.column
                    );
                    var containsAnchor =
    ...
    position: absolute;\
        ...
        (function () {
            this.insertSnippet = function (content, options) {
                return exports.snippetManager.insertSnippet(
                    this,
                    content,
                    options
                );
        ...
        var AcePopup = function (parentNode) {
            ...
            popup.setRow = function (line) {
                ...
                if (selectionMarker.start.row != line) {
                    ...
                    selectionMarker.start.row = selectionMarker.end.row =
                        line || 0;
                    popup.session._emit("changeBackMarker");
            ...
            popup.show = function (pos, lineHeight, topdownOnly) {
                ...
                if (allowTopdown && top + lineHeight + maxH > screenHeight) {
                    ...
                    top += lineHeight;
                    renderer.$maxPixelHeight =
                        screenHeight - top - 0.2 * lineHeight;
                    el.style.top = top + "px";
                    el.style.bottom = "";
    ...
    function (require, exports, module) {
        ...
        (function () {
            ...
            this.changeListener = function (e) {
                ...
                if (
                    cursor.row != this.base.row ||
                    cursor.column < this.base.column
                ) {
                    this.detach();
                }
        ...
        var loadSnippetFile = function (id) {
            ...
            config.loadModule(snippetFilePath, function (m) {
                if (m) {
                    ...
                    if (m.includeScopes) {
                        snippetManager.snippetMap[m.scope].includeScopes =
                            m.includeScopes;
        ...
        require("../config").defineOptions(Editor.prototype, "editor", {
            enableBasicAutocompletion: {
                set: function (val) {
                    if (val) {
                        if (!this.completers)
                            this.completers = Array.isArray(val)
                                ? val
                                : completers;
