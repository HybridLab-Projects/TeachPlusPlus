    ...
    var RelationBehavior = function () {
        ...
        this.clickViewListRecord = function (recordId, relationId, sessionKey) {
            var newPopup = $("<a />"),
                ...
                requestData = paramToObj(
                    "data-request-data",
                    $container.data("request-data")
                );
        ...
        this.clickManageListRecord = function (
            recordId,
            relationId,
            sessionKey
        ) {
        ...
        this.clickManagePivotListRecord = function (
            foreignId,
            relationId,
            sessionKey
        ) {
        ...
        this.changed = function (relationId, event) {
            $(
                '[data-field-name="' + relationId + '"]'
            ).trigger("change.oc.formwidget", { event: event });
        };
        ...
        this.bindToPopups = function (container, vars) {
            $(container).on("show.oc.popup", function (
                event,
                $trigger,
                $modal
            ) {
