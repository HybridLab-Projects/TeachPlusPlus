...
+(function ($) {
    ...
    var ImportBehavior = function () {
        ...
        this.bindColumnSorting = function () {
             ...
             * Unbind existing
             */
            $("#importDbColumns > ul, .import-column-bindings > ul").each(
                function () {
                    var $this = $(this);
            ...
            $("#importDbColumns > ul, .import-column-bindings > ul").sortable(
                sortableOptions
            );
        };

        this.onDropColumn = function ($dbItem, container, _super, event) {
            var $fileColumns = $("#importFileColumns"),
                $fileItem,
        ...
        this.autoMatchColumns = function () {
            ...
            $("#importDbColumns li").each(function () {
                ...
                if (fileColumns[name]) {
                    $this.appendTo(
                        $(".import-column-bindings > ul", fileColumns[name])
                    );
        ...
        this.matchColumn = function ($dbItem, $fileItem) {
            ...
            $dbItemMatchInput.attr(
                "name",
                "column_match[" + matchColumnId + "][]"
            );
