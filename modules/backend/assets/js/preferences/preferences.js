$(document).ready(function () {
    ...
    $("#Form-field-Preference-editor_show_invisibles").on(
        "change",
        function () {
    ...
    $("#Form-field-Preference-editor_enable_snippets").on(
        "change",
        function () {
    ...
    $("#Form-field-Preference-editor_display_indent_guides").on(
        "change",
        function () {
    ...
    $("#Form-field-Preference-editor_show_print_margin").on(
        "change",
        function () {
    ...
    $("#Form-field-Preference-editor_highlight_active_line").on(
        "change",
        function () {
