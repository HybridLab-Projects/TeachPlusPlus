...
+(function ($) {
    ...
    TabFormExpandControls.prototype.registerHandlers = function () {
        ...
        this.$tabsControlElement.on(
            "click",
            '[data-control="tabless-collapse-icon"]',
            this.proxy(this.tablessCollapseClicked)
        );
        this.$tabsControlElement.on(
            "click",
            '[data-control="primary-collapse-icon"]',
            this.proxy(this.primaryCollapseClicked)
        );
    };

    TabFormExpandControls.prototype.unregisterHandlers = function () {
        this.$tabsControlElement.off(
            "initTab.oc.tab",
            this.proxy(this.initTab)
        );
        this.$tabsControlElement.off(
            "click",
            '[data-control="tabless-collapse-icon"]',
    ...
    TabFormExpandControls.prototype.initTab = function (ev, data) {
        if ($(ev.target).attr("id") != this.tabsControlId) return;
        ...
        if (
            ...
            this.getLocalStorageValue("tabless", 0) == 1
        ) {
    ...
    TabFormExpandControls.prototype.primaryCollapseClicked = function (ev) {
        ...
        this.setLocalStorageValue(
            "primary",
            $primaryPanel.hasClass("collapsed") ? 1 : 0
        );
    ...
    TabFormExpandControls.prototype.createTablessCollapseIcon = function () {
        return $(
            '<a href="javascript:;" class="tab-collapse-icon tabless" data-control="tabless-collapse-icon"><i class="icon-chevron-up"></i></a>'
        );
    };

    TabFormExpandControls.prototype.createPrimaryCollapseIcon = function () {
        return $(
            '<a href="javascript:;" class="tab-collapse-icon primary" data-control="primary-collapse-icon"><i class="icon-chevron-down"></i></a>'
        );
    };

    TabFormExpandControls.prototype.generateStorageKey = function (section) {
        return (
            "oc" + section + this.tabsControlId.replace("-", "") + "collapsed"
        );
    };
    ...
    TabFormExpandControls.prototype.getLocalStorageValue = function (
        section,
        defaultValue
    ) {
    ...
    TabFormExpandControls.prototype.setLocalStorageValue = function (
        section,
        value
    ) {
        var key = this.generateStorageKey(section);
