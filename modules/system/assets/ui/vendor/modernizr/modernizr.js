...
!(function (e, t, n) {
    ...
    function a(e) {
        ...
        Modernizr._config.enableClasses &&
            ((t += " " + n + e.join(" " + n)),
            P ? (k.className.baseVal = t) : (k.className = t));
    }
    function i() {
    ...
    function v(e, t, o, a) {
        ...
        for (
            ...
            (u = !0), (G.modElem = i(v.shift())), (G.style = G.modElem.style);
    ...
    var N = "Moz O ms Webkit",
        O = S._config.usePrefixes ? N.toLowerCase().split(" ") : [];
    S._domPrefixes = O;
    var z = (function () {
        function e(e, t) {
            var o;
    ...
    (S.hasEvent = z),
        ...
        Modernizr.addTest("opacity", function () {
            var e = i("a").style;
            return (
                (e.cssText = _.join("opacity:.55;")), /^0.55$/.test(e.opacity)
            );
        }),
    ...
    Modernizr.input = (function (t) {
        ...
        return (
            M.list && (M.list = !(!i("datalist") || !e.HTMLDataListElement)), M
        );
    })(A);
    ...
    (Modernizr.inputtypes = (function (e) {
        for (var r, o, a, i = e.length, s = "1)", c = 0; i > c; c++)
            R.setAttribute("type", (r = e[c])),
                (a = "text" !== R.type && "style" in R),
                a &&
                    ((R.value = s),
    ...
    W
        ...
        : I('@font-face {font-family:"font";src:url("https://")}', function (
              e,
              n
          ) {
    ...
    Modernizr.addAsyncTest(function () {
        ...
        if (t) {
            var r = "modernizr-" + Math.random(),
                o = t.open(r);
            (o.onerror = function () {
                o.error && "InvalidStateError" === o.error.name
                    ? u("indexeddb", !1)
                    : (u("indexeddb", !0), T(t, r));
            }),
        ...
        Modernizr.addTest("forcetouch", function () {
            return z(K("mouseforcewillbegin", e, !1), e)
