...
+(function ($) {
    ...
    Sortable.prototype.init = function () {
        ...
        if (this.options.onDragStart) {
            sortableOverrides.onDragStart = function (
                $item,
                container,
                _super,
                event
        ...
        if (this.options.onDrag) {
            sortableOverrides.onDrag = function (
                $item,
                position,
                _super,
                event
        ...
        if (this.options.onDrop) {
            sortableOverrides.onDrop = function (
                $item,
                container,
                _super,
                event
        ...
        this.$el.jqSortable(
            $.extend({}, sortableDefaults, this.options, sortableOverrides)
        );
    };
    ...
    Sortable.prototype.onDragStart = function (
        $item,
        container,
        _super,
        event
        ...
        if (this.options.tweakCursorAdjustment) {
            this.cursorAdjustment = this.options.tweakCursorAdjustment(
                this.cursorAdjustment
            );
        }
    ...
    $.fn.sortable = function (option) {
        ...
        return this.each(function () {
            ...
            if (!data)
                $this.data("oc.sortable", (data = new Sortable(this, options)));
