...
+(function ($) {
    ...
    var ObjectEditor = function (
        ...
        if (propertyDefinition.properties === undefined) {
            this.throwError(
                "The properties property should be specified in the object editor configuration."
            );
        }
    ...
    ObjectEditor.prototype.build = function () {
        var currentRow = this.containerCell.parentNode,
            ...
            values = this.inspector.getPropertyValue(
        ...
        this.childInspector = new $.oc.inspector.surface(
            ...
            values,
            this.inspector.getInspectorUniqueId() +
                "-" +
                this.propertyDefinition.property,
            options,
            this.inspector,
    ...
    ObjectEditor.prototype.getUndefinedValue = function () {
        ...
        for (
            var i = 0, len = this.propertyDefinition.properties.length;
            i < len;
            i++
        ) {
