...
+(function ($) {
    ...
    var ExternalParameterEditor = function (
        inspector,
        propertyDefinition,
        containerCell,
        initialValue
    ...
    ExternalParameterEditor.prototype.init = function () {
        this.tooltipText =
            "Click to enter the external parameter name to load the property value from";
    ...
    ExternalParameterEditor.prototype.showEditor = function (building) {
        ...
        link.setAttribute(
            "data-original-title",
            "Click to enter the property value"
        );
    ...
    ExternalParameterEditor.prototype.hideEditor = function () {
        ...
        var propertyEditor = this.inspector.findPropertyEditor(
            this.propertyDefinition.property
        );
    ...
    ExternalParameterEditor.prototype.toggleEditorVisibility = function (show) {
        ...
        if (!show) {
            height = this.containerCell.getAttribute(
                "data-inspector-cell-height"
            );

            if (!height) {
                height = $(this.containerCell).height();
                this.containerCell.setAttribute(
                    "data-inspector-cell-height",
                    height
                );
            }
    ...
    ExternalParameterEditor.prototype.validate = function (silentMode) {
        ...
        if (value.length === 0) {
            if (!silentMode) {
                $.oc.flashMsg({
                    text: "Please enter the external parameter name.",
                    class: "error",
                    interval: 5,
                });
                this.focus();
    ...
    ExternalParameterEditor.prototype.onInputChange = function () {
        this.inspector.markPropertyChanged(
            this.propertyDefinition.property,
            true
        );
    };
    ...
    ExternalParameterEditor.prototype.unregisterHandlers = function () {
        ...
        this.getLink().removeEventListener(
            "click",
            this.proxy(this.toggleEditor)
        );
    ...
    ExternalParameterEditor.prototype.getContainer = function () {
        return this.containerCell.querySelector(
    ...
    ExternalParameterEditor.prototype.isEditorVisible = function () {
        return $.oc.foundation.element.hasClass(
            this.getContainer(),
            "editor-visible"
        );
    };
