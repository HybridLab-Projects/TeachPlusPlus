...
!(function ($) {
    ...
    Autocomplete.prototype = {
        ...
        show: function () {
            var offset = this.options.bodyContainer
                    ? this.$element.offset()
        ...
        listen: function () {
            ...
            this.$menu
                ...
                .on(
                    "mouseenter.autocomplete",
                    "li",
                    $.proxy(this.mouseenter, this)
                )
                .on(
                    "mouseleave.autocomplete",
                    "li",
        ...
        keydown: function (e) {
            this.suppressKeyPressRepeat = ~$.inArray(e.key, [
                "ArrowDown",
                "ArrowUp",
                "Tab",
                "Enter",
