...
+(function ($) {
    ...
    LengthValidator.prototype.isValid = function (value) {
        ...
        if (typeof value == "boolean") {
            this.throwError(
                "The Length Inspector validator cannot work with Boolean values."
            );
        }
        ...
        if (this.options.min !== undefined || this.options.max !== undefined) {
            if (this.options.min !== undefined) {
                if (this.options.min.value === undefined) {
                    throw new Error(
                        "The min.value parameter is not defined in the Length Inspector validator configuration."
                    );
                }
                ...
                if (length < this.options.min.value) {
                    return this.options.min.message !== undefined
                        ...
                        : "The value should not be shorter than " +
            ...
            if (this.options.max !== undefined) {
                if (this.options.max.value === undefined)
                    throw new Error(
                        "The max.value parameter is not defined in the Length Inspector validator configuration."
                    );

                if (length > this.options.max.value) {
                    return this.options.max.message !== undefined
                        ? this.options.max.message
                        : "The value should not be longer than " +
