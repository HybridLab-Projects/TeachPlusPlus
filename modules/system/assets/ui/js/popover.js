...
+(function ($) {
    ...
    Popover.prototype.show = function (options) {
        ...
        var showEvent = jQuery.Event("show.oc.popover", {
        ...
        if (this.options.closeOnEsc) {
            $(document).on("keyup.oc.popover", function (e) {
                if ($(e.target).hasClass("select2-offscreen")) return false;
    ...
    Popover.prototype.reposition = function () {
        var placement = this.calcPlacement(),
            position = this.calcPosition(placement);

        this.$container.removeClass(
            "placement-center placement-bottom placement-top placement-left placement-right"
        );
    ...
    Popover.prototype.fitsLeft = function (dimensions) {
        return (
            dimensions.spaceLeft >= dimensions.containerWidth &&
    ...
    Popover.prototype.fitsRight = function (dimensions) {
        return (
            dimensions.spaceRight >= dimensions.containerWidth &&
            dimensions.spaceHorizontalBottom >= dimensions.containerHeight
        );
    };
    ...
    Popover.prototype.fitsBottom = function (dimensions) {
        return (
            dimensions.spaceBottom >= dimensions.containerHeight &&
    ...
    Popover.prototype.fitsTop = function (dimensions) {
        return (
            dimensions.spaceTop >= dimensions.containerHeight &&
            dimensions.spaceVerticalRight >= dimensions.containerWidth
        );
    };
    ...
    Popover.prototype.calcPlacement = function () {
        ...
        for (var index in placementFunctions) {
            if (placementFunctions[index](dimensions)) return index;
        }
    ...
    Popover.prototype.calcPosition = function (placement) {
        ...
        switch (placement) {
            case "left":
                var realOffset =
                    this.options.offsetY === undefined
                        ? this.options.offset
            ...
            case "top":
                var realOffset =
                    this.options.offsetX === undefined
                        ? this.options.offset
        ...
        if (!this.options.container) return result;
    ...
    Popover.prototype.onDocumentClick = function (e) {
        if (!this.options.closeOnPageClick) return;

        if (
            this.options.onCheckDocumentClickTarget &&
            this.options.onCheckDocumentClickTarget(e.target)
        ) {
            return;
        }

        if ($.contains(this.$container.get(0), e.target)) return;
