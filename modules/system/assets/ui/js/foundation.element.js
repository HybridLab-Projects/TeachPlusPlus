    ...
    var Element = {
        ...
        addClass: function (el, className) {
            ...
            for (var i = 0, len = classes.length; i < len; i++) {
                ...
                if (el.classList) el.classList.add(currentClass);
                else el.className += " " + currentClass;
            }
        },
        ...
        absolutePosition: function (element, ignoreScrolling) {
            ...
            do {
                ...
                if (ignoreScrolling !== true) top -= element.scrollTop || 0;
        ...
        elementContainsPoint: function (element, point) {
            var elementPosition = $.oc.foundation.element.absolutePosition(
                    element
                ),
