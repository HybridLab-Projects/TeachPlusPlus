...
+(function ($) {
    ...
    if ($.oc.inspector === undefined) $.oc.inspector = {};
    ...
    var Surface = function (
        ...
        this.parsedProperties = $.oc.inspector.engine.processPropertyGroups(
            properties
        );
        ...
        if (!this.parentSurface) {
            this.groupManager = new $.oc.inspector.groupManager(
                this.inspectorUniqueId
            );
        }
    ...
    Surface.prototype.registerHandlers = function () {
        if (!this.parentSurface) {
            $(this.tableContainer).one(
                "dispose-control",
                this.proxy(this.dispose)
            );
            $(this.tableContainer).on(
                "click",
                "tr.group, tr.control-group",
                this.proxy(this.onGroupClick)
            );
            $(this.tableContainer).on(
                "focus-control",
                this.proxy(this.focusFirstEditor)
            );
        }
    };
    ...
    Surface.prototype.build = function () {
        ...
        for (
            var i = 0, len = this.parsedProperties.properties.length;
            i < len;
            i++
        ) {
            ...
            if (property.itemType == "group") {
                currentGroup = this.getGroupManager().createGroup(
                    property.groupIndex,
                    this.group
                );
            } else {
    ...
    Surface.prototype.buildRow = function (property, group) {
        ...
        if (property.property) {
            ...
            row.setAttribute(
                "data-property-path",
                this.getPropertyPath(property.property)
            );
        }
        ...
        $.oc.foundation.element.addClass(
            row,
            this.getRowCssClass(property, group)
        );
        ...
        titleSpan.setAttribute(
            "title",
            this.escapeJavascriptString(property.title)
        );
    ...
    Surface.prototype.focusFirstEditor = function () {
        ...
        for (var i = 0, len = this.editors.length; i < len; i++) {
            ...
            if (
                ...
                externalParameterEditor.isEditorVisible()
            ) {
    ...
    Surface.prototype.getRowCssClass = function (property, group) {
        ...
        if (property.itemType == "property") {
            ...
            if (group.parentGroup) {
                result += this.getGroupManager().isGroupExpanded(group)
                    ? " expanded"
                    : " collapsed";
            }
        }
    ...
    Surface.prototype.buildGroupExpandControl = function (
        titleSpan,
        property,
        force,
        hasChildSurface,
        ...
        var groupIndex = this.getGroupManager().getGroupIndex(group),
            statusClass = this.getGroupManager().isGroupExpanded(group)
                ? "expanded"
                : "",
    ...
    Surface.prototype.buildPropertyDescription = function (property) {
        ...
        span.setAttribute(
            "title",
            this.escapeJavascriptString(property.description)
        );
    ...
    Surface.prototype.buildExternalParameterEditor = function (tbody) {
        ...
        for (var i = 0, len = rows.length; i < len; i++) {
            ...
            if (
                $.oc.foundation.element.hasClass(
                    row,
            ...
            if (
                propertyEditor &&
                !propertyEditor.supportsExternalParameterEditor()
            ) {
                continue;
            }
            ...
            var editor = new $.oc.inspector.externalParameterEditor(
                this,
                propertyDefinition,
                cell,
                initialValue
    ...
    Surface.prototype.applyGroupIndexAttribute = function (
        property,
        row,
        group,
        isGroupedControl
        ...
        if (property.itemType == "group" || isGroupedControl) {
            row.setAttribute(
                "data-group-index",
                this.getGroupManager().getGroupIndex(group)
            );
            row.setAttribute(
                "data-parent-group-index",
                this.getGroupManager().getGroupIndex(group.parentGroup)
            );
        } else {
            if (group.parentGroup) {
                row.setAttribute(
    ...
    Surface.prototype.toggleGroup = function (row, forceExpand) {
        ...
        if (
            $.oc.foundation.element.hasClass(link, "expanded") &&
            !forceExpand
        ) {
        ...
        var propertyRows = groupManager.findGroupRows(
                table,
                groupIndex,
                !collapse
            ),
    ...
    Surface.prototype.expandOrCollapseRows = function (
        rows,
        collapse,
        duration,
        noAnimation
        ...
        if (row) {
            if (!noAnimation) {
                setTimeout(function toggleRow() {
                    $.oc.foundation.element.toggleClass(
                        row,
                        "collapsed",
                        collapse
                    );
    ...
    Surface.prototype.buildEditor = function (row, property, dataTable, group) {
        ...
        var editor = new $.oc.inspector.propertyEditors[type](
            this,
            property,
            cell,
            group
        ...
        if (editor.isGroupedEditor()) {
            ...
            this.buildGroupExpandControl(
                row.querySelector("span.title-element"),
                property,
                true,
                editor.hasChildSurface(),
                editor.group
            );
    ...
    Surface.prototype.setPropertyValue = function (
        property,
        value,
        supressChangeEvents,
        forceEditorUpdate
        ...
        if (!supressChangeEvents) {
            if (
                this.originalValues[property] === undefined ||
            ...
            this.getRootSurface().notifyEditorsPropertyChanged(
                propertyPath,
                value
            );
    ...
    Surface.prototype.notifyEditorsPropertyChanged = function (
        propertyPath,
        value
    ) {
    ...
    Surface.prototype.markPropertyChanged = function (property, changed) {
        var propertyPath = this.getPropertyPath(property),
            row = this.tableContainer.querySelector(
    ...
    Surface.prototype.findExternalParameterEditor = function (property) {
        for (
            var i = 0, len = this.externalParameterEditors.length;
            i < len;
            i++
        ) {
            if (
                this.externalParameterEditors[i].getPropertyName() == property
            ) {
    ...
    Surface.prototype.mergeChildSurface = function (surface, mergeAfterRow) {
        var rows = surface.tableContainer.querySelectorAll(
            "table.inspector-fields > tbody > tr"
        );
        ...
        for (var i = rows.length - 1; i >= 0; i--) {
            ...
            mergeAfterRow.parentNode.insertBefore(
                row,
                mergeAfterRow.nextSibling
            );
    ...
    Surface.prototype.disposeControls = function () {
        var tooltipControls = this.tableContainer.querySelectorAll(
            ".with-tooltip"
        );
    ...
    Surface.prototype.getRootTable = function () {
        return this.getRootSurface().container.querySelector(
    ...
    Surface.prototype.getValues = function () {
        ...
        for (
            ...
            var value = null,
                externalParameterEditor = this.findExternalParameterEditor(
                    property.property
                );
            ...
            if (
                ...
                if (
                    property.ignoreIfEmpty !== undefined &&
                    (property.ignoreIfEmpty === true ||
                        property.ignoreIfEmpty === "true") &&
                    editor
                ) {
                ...
                if (
                    property.ignoreIfDefault !== undefined &&
                    (property.ignoreIfDefault === true ||
                        property.ignoreIfDefault === "true") &&
                    editor
                ) {
    ...
    Surface.prototype.getValidValues = function () {
        ...
        for (var property in allValues) {
            ...
            if (
                externalEditor &&
                externalEditor.isEditorVisible() &&
                !externalEditor.validate(true)
            ) {
    ...
    Surface.prototype.validate = function (silentMode) {
        ...
        for (var i = 0, len = this.editors.length; i < len; i++) {
            var editor = this.editors[i],
                externalEditor = this.findExternalParameterEditor(
    ...
    Surface.prototype.hasChanges = function (originalValues) {
        var values =
            originalValues !== undefined ? originalValues : this.originalValues;
