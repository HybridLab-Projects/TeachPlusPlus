...
+(function ($) {
    ...
    var RowLink = function (element, options) {
        ...
        tr.each(function () {
            var link = $(this)
                ...
                .filter(function () {
                    return (
                        !$(this).closest("td").hasClass(options.excludeClass) &&
            ...
            var href = link.attr("href"),
                onclick =
                    typeof link.get(0).onclick == "function"
                        ? link.get(0).onclick
                        : null,
    ...
    $.fn.rowLink = function (option) {
        ...
        return this.each(function () {
            ...
            if (!data)
                $this.data("oc.rowlink", (data = new RowLink(this, options)));
