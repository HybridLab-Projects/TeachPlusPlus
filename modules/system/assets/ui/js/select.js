            ...
            if (separators) {
                ...
                if ($element.hasClass("select-no-dropdown")) {
                    ...
                    $element.on("select2:closing", function () {
                        if (
                            $(
                                ".select2-dropdown.select-no-dropdown:first .select2-results__option--highlighted"
                            ).length > 0
                        ) {
                            $(
                                ".select2-dropdown.select-no-dropdown:first .select2-results__option--highlighted"
                            ...
                            $(
                                ".select2-dropdown.select-no-dropdown:first .select2-results__option:first"
