...
+(function ($) {
    ...
    InspectorManager.prototype.init = function () {
        $(document).on(
            "click",
            "[data-inspectable]",
            this.proxy(this.onInspectableClicked)
        );
    };
    ...
    InspectorManager.prototype.getContainerElement = function ($element) {
        ...
        var $container = $containerHolder.find(
            $containerHolder.data("inspector-container")
        );
    ...
    InspectorManager.prototype.createInspectorPopup = function (
        $element,
        containerSupported
    ) {
    ...
    InspectorManager.prototype.createInspectorContainer = function (
        $element,
        $container
    ) {
        var options = $.extend(this.loadElementOptions($element), {
    ...
    InspectorManager.prototype.switchToContainer = function (wrapper) {
        ...
        new $.oc.inspector.wrappers.container(
            wrapper.$element,
            wrapper,
            options
        );
    ...
    InspectorManager.prototype.createInspector = function (element) {
        ...
        if (!$container) {
            ...
            if (
                !this.applyValuesFromContainer($container) ||
                !this.containerHidingAllowed($container)
            ) {
                return;
            }
    ...
    InspectorManager.prototype.setContainerPreference = function (value) {
        ...
        return localStorage.setItem(
            "oc.inspectorUseContainer",
            value ? "true" : "false"
        );
    };

    InspectorManager.prototype.applyValuesFromContainer = function (
        $container
    ) {
