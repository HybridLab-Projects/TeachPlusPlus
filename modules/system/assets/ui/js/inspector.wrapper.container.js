...
+(function ($) {
    ...
    InspectorContainer.prototype.createSurfaceAndUi = function (
        properties,
        values
    ) {
        this.buildUi();
    ...
    InspectorContainer.prototype.buildHead = function () {
        ...
        detachButton.setAttribute(
            "class",
            "oc-icon-external-link-square detach"
        );
    ...
    InspectorContainer.prototype.isScrollable = function () {
        return (
            this.options.container.data("inspector-scrollable") !== undefined
        );
    };

    InspectorContainer.prototype.isLiveUpdateEnabled = function () {
        return (
            this.options.container.data("inspector-live-update") !== undefined
        );
    };
    ...
    InspectorContainer.prototype.getLayout = function () {
        return this.options.container
            .get(0)
            .querySelector("div.flex-layout-column");
    };
    ...
    InspectorContainer.prototype.registerHandlers = function () {
        this.options.container.on(
            "apply.oc.inspector",
            this.proxy(this.onApplyValues)
        );
        this.options.container.on(
            "beforeContainerHide.oc.inspector",
            this.proxy(this.onBeforeHide)
        );
    };
