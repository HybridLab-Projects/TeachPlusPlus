...
$.oc.langMessages["nb-no"] = $.extend($.oc.langMessages["nb-no"] || {}, {
    markdowneditor: {
    ...
    eventlog: {
        ...
        tabs: { formatted: "Formattert", raw: "Raw" },
        editor: {
            title: "Kildekodeeditor",
            description:
                "Ditt operativsystem b\u00f8r v\u00e6re konfigurert for \u00e5 \u00e5pne ett av disse URL-schemaene.",
            openWith: "\u00c5pne med",
