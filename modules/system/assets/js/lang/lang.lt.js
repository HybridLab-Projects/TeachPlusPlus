...
$.oc.langMessages["lt"] = $.extend($.oc.langMessages["lt"] || {}, {
    markdowneditor: {
    ...
    mediamanager: {
        ...
        invalid_file_empty_insert:
            "Pasirinkite fail\u0105 \u012f kur\u012f norite \u012fterpti nuorod\u0105.",
        invalid_file_single_insert: "Pasirinkite vien\u0105 fail\u0105.",
        invalid_image_empty_insert:
            "Pasirinkite pavaiksliuk\u0105(us) \u012fterpimui.",
        invalid_video_empty_insert:
            "Pasirinkite video fail\u0105 \u012fterpimui.",
        invalid_audio_empty_insert:
            "Pasirinkite audio fail\u0105 \u012fterpimui.",
    },
    alert: {
    ...
    eventlog: {
        ...
        tabs: { formatted: "Formatuota", raw: "Nepadorotas" },
        editor: {
            title: "\u0160altinio kodo redaktorius",
            description:
                "J\u016bs\u0173 operacin\u0117 sistema tur\u0117t\u0173 b\u016bti suderinta vienai i\u0161 \u0161i\u0173 URL schem\u0173 nuskaitymui.",
            openWith: "Atidaryti su",
            remember_choice:
                "Atsiminti pasirinkt\u0105 parinkt\u012f \u0161iai sesijai",
            open: "Atidaryti",
            cancel: "At\u0161aukti",
        },
    },
