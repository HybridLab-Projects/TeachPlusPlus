...
$.oc.langMessages["cs"] = $.extend($.oc.langMessages["cs"] || {}, {
    markdowneditor: {
    ...
    mediamanager: {
        ...
        invalid_file_empty_insert:
            "Pros\u00edm vyberte soubor, na kter\u00fd se vlo\u017e\u00ed odkaz.",
        ...
        invalid_video_empty_insert:
            "Vyberte video soubor pro vlo\u017een\u00ed.",
        invalid_audio_empty_insert:
            "Vyberte audio soubor pro vlo\u017een\u00ed.",
    },
    alert: {
    ...
    eventlog: {
        ...
        editor: {
            ...
            description:
                "V\u00e1\u0161 opera\u010dn\u00ed syst\u00e9m by m\u011bl b\u00fdt konfigurov\u00e1n tak, aby naslouchal jednomu z t\u011bchto sch\u00e9mat adres URL.",
            openWith: "Otev\u0159\u00edt v",
