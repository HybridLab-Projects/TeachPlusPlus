...
$.oc.langMessages["ca"] = $.extend($.oc.langMessages["ca"] || {}, {
    markdowneditor: {
        formatting: "Formatar",
        quote: "Quota",
        code: "Codi",
    ...
    mediamanager: {
        ...
        invalid_file_empty_insert:
            "Si us plau selecciona l'arxiu a enlla\u00e7ar.",
        invalid_file_single_insert: "Si us plau selecciona un sol arxiu.",
        invalid_image_empty_insert:
            "Si us plau selecciona imatge(s) per inserir.",
        invalid_video_empty_insert:
            "Si us plau selecciona un arxiu de v\u00eddeo per inserir.",
        invalid_audio_empty_insert:
            "Si us plau selecciona un arxiu d'\u00e0udio per inserir.",
    },
    alert: {
    ...
    eventlog: {
        ...
        tabs: { formatted: "Formatat", raw: "Cru" },
        editor: {
            title: "Editor de codi font",
            description:
                "El teu sistema operatiu hauria d'estar configurat per escoltar un d'aquests esquemes d'URL.",
            openWith: "Obrir amb",
            remember_choice:
                "Recordar l'opci\u00f3 seleccionada durant aquesta sessi\u00f3",
            open: "Obrir",
            cancel: "Cancel\u00b7lar",
        },
    },
