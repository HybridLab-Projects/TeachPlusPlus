...
$.oc.langMessages["nl"] = $.extend($.oc.langMessages["nl"] || {}, {
    markdowneditor: {
        formatting: "Opmaak",
        quote: "Quote",
        code: "Code",
    ...
    mediamanager: {
        ...
        invalid_file_empty_insert:
            "Selecteer bestand om een link naar te maken.",
        ...
        invalid_video_empty_insert:
            "Selecteer een video bestand om in te voegen.",
        invalid_audio_empty_insert:
            "Selecteer een audio bestand om in te voegen.",
    },
    alert: {
    ...
    eventlog: {
        ...
        tabs: { formatted: "Geformatteerd", raw: "Bronversie" },
        editor: {
            title: "Broncode editor",
            description:
                "Je besturingssysteem moet in staat zijn om met deze URL-schema's om te kunnen gaan.",
            openWith: "Openen met",
            remember_choice:
                "Onthoudt de geselecteerde optie voor deze browser-sessie",
            open: "Openen",
            cancel: "Annuleren",
        },
    },
