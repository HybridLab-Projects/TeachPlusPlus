...
$.oc.langMessages["it"] = $.extend($.oc.langMessages["it"] || {}, {
    markdowneditor: {
    ...
    mediamanager: {
        ...
        invalid_file_empty_insert:
            "Si prega di selezionare un file di cui inserire il collegamento.",
        invalid_file_single_insert: "Si prega di selezionare un singolo file.",
        invalid_image_empty_insert:
            "Si prega di selezionare l\\'immagine/le immagini da inserire.",
        invalid_video_empty_insert:
            "Si prega di selezionare un file video da inserire.",
        invalid_audio_empty_insert:
            "Si prega di selezionare un file audio da inserire.",
    },
    alert: {
    ...
    eventlog: {
        ...
        tabs: { formatted: "Formattato", raw: "Grezzo" },
        editor: {
            title: "Editor codice sorgente",
            description:
                "Il tuo sistema operativo deve essere configurato per ascoltare uno di questi schemi URL.",
            openWith: "Apri con",
            remember_choice:
                "Ricorda l'opzione selezionata per questa sessione",
            open: "Apri",
            cancel: "Annulla",
        },
    },
