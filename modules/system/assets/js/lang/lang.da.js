...
$.oc.langMessages["da"] = $.extend($.oc.langMessages["da"] || {}, {
    markdowneditor: {
    ...
    mediamanager: {
        ...
        invalid_file_empty_insert:
            "V\u00e6lg venligst en fil, at inds\u00e6tte et link til.",
        invalid_file_single_insert: "V\u00e6lg venligst en enkel fil.",
        invalid_image_empty_insert:
            "V\u00e6lg venligst et eller flere billeder, at inds\u00e6tte.",
        invalid_video_empty_insert:
            "V\u00e6lg venligst en videofil, at inds\u00e6tte.",
        invalid_audio_empty_insert:
            "V\u00e6lg venligst en lydfil, at inds\u00e6tte.",
    },
    alert: {
    ...
    eventlog: {
        ...
        tabs: { formatted: "Formateret", raw: "R\u00e5" },
        editor: {
            title: "Kildekode redigeringsv\u00e6rkt\u00f8j",
            description:
                "Dit operativsystem b\u00f8r konfigureres til at lytte til et af disse URL-skemaer.",
            openWith: "\u00c5ben med",
