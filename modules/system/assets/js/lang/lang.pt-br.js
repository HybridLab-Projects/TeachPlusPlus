...
$.oc.langMessages["pt-br"] = $.extend($.oc.langMessages["pt-br"] || {}, {
    markdowneditor: {
    ...
    mediamanager: {
        ...
        invalid_file_empty_insert:
            "Por favor, selecione o arquivo para criar o link.",
    ...
    eventlog: {
        ...
        editor: {
            ...
            description:
                "Seu sistema operacional deve ser configurado para ouvir um desses esquemas de URL.",
            openWith: "Abrir com",
            remember_choice:
