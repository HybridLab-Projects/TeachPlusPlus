...
$.oc.langMessages["sl"] = $.extend($.oc.langMessages["sl"] || {}, {
    markdowneditor: {
    ...
    mediamanager: {
        ...
        invalid_file_empty_insert:
            "Izberite datoteko, do katere \u017eelite vstaviti povezavo.",
        ...
        invalid_audio_empty_insert:
            "Izberite zvo\u010dni posnetek za vstavljanje.",
    },
    alert: {
    ...
    eventlog: {
        ...
        tabs: { formatted: "Oblikovano", raw: "Brez oblikovanja" },
        editor: {
            title: "Urejevalnik izvorne kode",
            description:
                "Va\u0161 operacijski sistem mora biti nastavljen tako, da upo\u0161teva eno od teh URL shem.",
