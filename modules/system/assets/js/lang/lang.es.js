...
$.oc.langMessages["es"] = $.extend($.oc.langMessages["es"] || {}, {
    markdowneditor: {
        formatting: "Formateo",
        quote: "Cita",
        code: "C\u00f3digo",
    ...
    mediamanager: {
        ...
        invalid_file_empty_insert:
            "Por favor seleccione archivo para insertar v\u00ednculo.",
        invalid_file_single_insert: "Por favor seleccione un solo archivo.",
        invalid_image_empty_insert:
            "Por favor seleccione una imagen(es) para insertar.",
        invalid_video_empty_insert:
            "Por favor seleccione un archivo de video para insertar.",
        invalid_audio_empty_insert:
            "Por favor seleccione un archivo de audio para insertar.",
    },
    alert: {
    ...
    eventlog: {
        ...
        tabs: { formatted: "Formateado", raw: "Sin formato" },
        editor: {
            title: "Seleccione el editor de c\u00f3digo fuente a usar",
            description:
                "Su entorno de sistema operativo debe estar configurado para escuchar a uno de estos esquemas de URL.",
            openWith: "Abrir con",
            remember_choice: "Remember selected option for this session",
            open: "Abrir",
            cancel: "Cancelar",
            rememberChoice:
                "Recuerde que la opci\u00f3n seleccionada para esta sesi\u00f3n del navegador",
        },
    },
});
