...
+(function ($) {
    ...
    InstallProcess.prototype.searchSubmit = function (el) {
        ...
        if (!$input.data("searchReady")) return;
    ...
    InstallProcess.prototype.renderSuggested = function (
        el,
        suggestedProducts
    ) {
        var self = this,
    ...
    InstallProcess.prototype.renderPartial = function (
        $el,
        name,
        data,
        options
        ...
        f = (function () {
            function c(b) {
                (b = b || {}),
                    ...
                    (this._get = b.rateLimiter
                        ? b.rateLimiter(this._get)
                        : this._get);
            }
            function e(c) {
                return function (d, e) {
                        ...
                        _getFromRemote: function (a, b) {
                            ...
                            return (
                                ...
                                (d = this.remote.replace
                                    ...
                                    : this.remote.url.replace(
                                          this.remote.wildcard,
                                          e
                                      )),
                ...
                function f(b) {
                    ...
                    return (
                        (c = h.exec(b.data)) &&
                            ...
                            e.className &&
                                (wrapperNode.className = e.className),
            ...
            function c(c) {
                ...
                (c = c || {}),
                    ...
                    (this.$input = a(c.input)
                        ...
                        .on("keydown.tt", h)),
                    0 === this.$hint.length &&
                        (this.setHintValue = this.getHintValue = this.clearHint =
                            b.noop),
                    b.isMsie()
                        ? this.$input.on(
                            ...
                            this.$el.empty(),
                                ...
                                !o && this.templates.empty
                                    ? this.$el
                                          .html(e())
                                          .prepend(
                                              p.templates.header ? l() : null
                                          )
                                          .append(
                                              p.templates.footer ? n() : null
                                          )
                                    : o &&
                                      this.$el
                                          .html(f())
            ...
            return (
                b.mixin(c.prototype, {
                    _onSuggestionClicked: function (a, b) {
                        var c;
                        (c = this.dropdown.getDatumForSuggestion(b)) &&
                            this._select(c);
                    },
                    ...
                    _onEnterKeyed: function (a, b) {
                        ...
                        (c = this.dropdown.getDatumForCursor()),
                            ...
                            c
                                ...
                                : this.autoselect &&
                                  d &&
                                  (this._select(d), b.preventDefault());
                    },
