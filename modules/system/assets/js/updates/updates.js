...
+(function ($) {
            ...
            eventChain.push(function () {
                ...
                $.request("onExecuteStep", {
                    ...
                    success: function (data) {
                        ...
                        if (
                            step.code == "completeUpdate" ||
                            step.code == "completeInstall"
                        )
                            this.success(data);
                        else self.setLoadingBar(false);
                    },
                    error: function (data) {
    ...
    UpdateProcess.prototype.setLoadingBar = function (state, message) {
        ...
        if (state) loadingBar.removeClass("bar-loaded");
        else loadingBar.addClass("bar-loaded");

        if (message) messageDiv.text(message);
    };
