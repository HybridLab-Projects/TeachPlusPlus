...
+(function ($) {
    ...
    var DragComponents = function (element, options) {
        ...
        function initDrag(event) {
            $componentList = $(
                "#cms-master-tabs > div.tab-content > .tab-pane.active .control-componentlist"
            );
            $el.addClass(self.options.placeholderClass);
            $clone.show();
            $editorArea = $(
                '#cms-master-tabs > div.tab-content > .tab-pane.active [data-control="codeeditor"]'
            );
        ...
        function startDrag(event) {
            ...
            if (Modernizr.touchevents) {
                ...
                $(window).on("mouseup.oc.dragcomponents", function (
                    mouseUpEvent
                ) {
                    var isClick =
        ...
        function moveDrag(event) {
            ...
            else $componentList.removeClass("droppable");
        }
        ...
        function stopDrag(click) {
            ...
            if (click) $(document.body).removeClass(self.options.dragClass);
    ...
    $.fn.dragComponents = function (option) {
        ...
        return this.each(function () {
            ...
            if (!data)
                $this.data(
                    "oc.dragcomponents",
                    (data = new DragComponents(this, options))
                );
    ...
    $(document).on(
        "mouseenter.oc.dragcomponents",
        '[data-control="dragcomponent"]',
        function () {
            $(this).dragComponents();
        }
    );
